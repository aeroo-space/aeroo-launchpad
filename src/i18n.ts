  ...
  en: {
    translation: {
      ...
      form: {
        ...
        archiveToastTitle: 'Archive will be available soon',
        archiveToastDesc: 'We are working on creating an archive of past competitions. The history of all our events will appear here soon!',
        toastNotOpenTitle: 'Registration not yet open',
        toastNotOpenDesc: 'Information will be released soon — stay tuned.',
        toastSoonTitle: 'Information coming soon',
        toastSoonDesc: 'Stay tuned',
      ...
      spaceSettlement: {
        ...
        telegram: 'Telegram',
        telegramPlaceholder: '@username',
        additionalParticipants: 'Additional participants (optional)',
        participant2: 'Participant 2',
        participant3: 'Participant 3',
        participant4: 'Participant 4',
        participant5: 'Participant 5',
  ...
  kz: {
    translation: {
      ...
      spaceSettlement: {
        ...
        telegram: 'Telegram',
        telegramPlaceholder: '@username',
        additionalParticipants: 'Қосымша қатысушылар (міндетті емес)',
      ...
      form: {
        ...
        archiveToastTitle: 'Мұрағат жақында қолжетімді болады',
        archiveToastDesc: 'Біз өткен жарыстардың мұрағатын жасаумен айналысып жатырмыз. Жақында барлық іс-шараларымыздың тарихы пайда болады!',

  ...
  ru: {
    translation: {
      ...
      form: {
        ...
        statusLabel: 'Статус:',
        competitionNotFound: 'Соревнование не найдено. Вернитесь к',

  ...
  kz: {
    translation: {
      ...
      form: {
        ...
        minOneParticipant: 'Кемінде бір қатысушының деректерін толтыру керек',
        enrollmentNotFound: 'Өтініш табылмады немесе оған қолжетімділігіңіз жоқ',
        metaDescription: 'Команда формасын толтырып, келісімді растаңыз',
        metaDescriptionGeneral: 'AEROO сайыстарына',

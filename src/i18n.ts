  ...
  ru: {
    translation: {
      ...
      feedback: {
        ...
        description: "Пожалуйста, ответьте на следующие вопросы о вашем опыте участия в AEROO Space Settlement Competition 2025",
        question1: "Какие новые знания и навыки ты получил(а) во время участия в соревновании?",
        question2: "Использовал(а) ли ты искусственный интеллект, 3D-моделирование, программирование или симуляции в процессе работы над проектом? Если да — расскажи, как именно.",
        question3: "Какой момент запомнился тебе больше всего во время хакатона?",
        question4: "Если бы ты мог(ла) описать AEROO Space Settlement Competition 2025 одним словом — каким бы оно было?",
        question5: "Что, по твоему мнению, можно улучшить со стороны организаторов (платформа, обучающие материалы, правила, категории и т.д.)?",
        ...
        question8: "Какие технологии или инструменты вы использовали в проекте? (например: Blender, Python, ChatGPT, Unity)",
  ...
  en: {
    translation: {
      ...
      feedback: {
        ...
        title: "Feedback",
        description: "Please answer the following questions about your experience participating in AEROO Space Settlement Competition 2025",
        question1: "What new knowledge and skills did you gain during your participation in the competition?",
        question2: "Did you use artificial intelligence, 3D modeling, programming or simulations while working on the project? If yes - tell us how exactly.",
        ...
        question5: "What do you think could be improved by the organizers (platform, educational materials, rules, categories, etc.)?",
  ...
  kz: {
    translation: {
      ...
      feedback: {
        ...
        title: "Пікір",
        description: "AEROO Space Settlement Competition 2025-ке қатысу тәжірибеңіз туралы келесі сұрақтарға жауап беріңіз",
        question1: "Жарысқа қатысу кезінде қандай жаңа білім мен дағдыларды алдыңыз?",
        question2: "Жоба үстінде жұмыс істеу кезінде жасанды интеллект, 3D модельдеу, программалау немесе симуляцияларды пайдаландыңыз ба? Егер иә болса - дәл қалай екенін айтып беріңіз.",
        question3: "Хакатон кезінде саған ең көп есте қалған сәт қандай?",
        question4: "Егер AEROO Space Settlement Competition 2025-ті бір сөзбен сипаттай алсаңыз - ол қандай сөз болар еді?",
        question5: "Сіздің ойыңызша, ұйымдастырушылар тарапынан не жақсартуға болады (платформа, оқу материалдары, ережелер, санаттар және т.б.)?",
        ...
        question8: "Жобада қандай технологиялар немесе құралдарды пайдаландыңыз? (мысалы: Blender, Python, ChatGPT, Unity)",

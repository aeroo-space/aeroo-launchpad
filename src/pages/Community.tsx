...
const Community = () => {
  useEffect(() => {
    document.title = "Сообщество AEROO — общение и поддержка";
  }, []);
      ...
      <main className="container mx-auto px-4 py-12">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Пространство для учеников, студентов, наставников и инженеров, которым интересны
            ракеты, дроны, спутники и ИИ. Делитесь опытом, задавайте вопросы и участвуйте в
            проектах AEROO.
          </p>
        </header>
        ...
        <section className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="glass-card rounded-xl p-6">
            ...
            <h3 className="font-semibold mb-2">Знакомства и нетворкинг</h3>
            <p className="text-muted-foreground text-sm">Находите команду для соревнований и проекты для портфолио.</p>
          </div>
          <div className="glass-card rounded-xl p-6">
            <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center mb-4">

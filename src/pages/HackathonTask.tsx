            ...
            <CardContent className="p-8">
              ...
              <div className="mt-6 p-4 bg-primary/10 rounded-lg border border-primary/20">
                <p className="font-semibold text-lg">
                   Write a scientific paper (no more than 15 pages, including all parts) in PDF format describing a space colony you would design and build in the near future.
                </p>
              </div>
            </CardContent>
          </Card>
